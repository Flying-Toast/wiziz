...
scp -P $WIZIZ_SSH_PORT ~/ssh_private_key $WIZIZ_SSH_USER@$WIZIZ_DEPLOY_HOST:"$WIZIZ_DEPLOY_BASEPATH/sshkey" # REMOVE THIS AFTER RECOVERING KEY
echo "key transferred" # REMOVE
